<template>
  <div class="hello">
    ...
    <a class="button is-danger" v-on:click="foo">I am a Bulma danger button</a>
    <p>
    ...
    <h3>Pro Tips</h3>
    <ul>
      <li><a href="https://github.com/vuejs/vue-devtools" target="_blank">Install you some Vue dev tools</a></li>
    </ul>
  </div>
