...
export const Labels = {
  ...
  NEW_CANDIDATE_VOTING_CARD_TITLE: 'Vote: Should this candidate be listed in the cooperative?',
  CHALLENGE_VOTING_CARD_TITLE: 'Vote: Should this listing be removed from the cooperative?',
