...
const listingAllRoute = '/listing/all'
const listingCandidatesRoute = '/listing/candidates'
const listingListedRoute = '/listing/listed'
const listingSingleCandidateRoute = '/listing/candidates/0xhash'
const listingSingleListedRoute = '/listing/listed/0xhash'
const userListingRoute = '/users/0xwallet/listing'
const userAllListingRoute = '/users/0xwallet/listing/all'
const userCandidatesRoute = '/users/0xwallet/listing/candidates'
const userListedRoute = '/users/0xwallet/listing/listed'
const userSingleCandidatesRoute = '/users/0xwallet/listing/candidates/0xhash'
const userSingleListedRoute = '/users/0xwallet/listing/listed/0xhash'
const listingNewRoute = '/listing/new'
