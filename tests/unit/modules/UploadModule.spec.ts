...
describe('UploadModule.ts', () => {
  ...
  it('correctly initializes and exposes properties', () => {
    ...
    expect(uploadModule.originalFilename).not.toBeNull()
  ...
  it ('correctly exposes getters', () => {
    ...
    expect(() => uploadModule.hash).toThrow('Public key cannot be empty')
  })
  ...
  it ('correctly mutates state', () => {
    ...
    uploadModule.setOriginalFilename('A dummy file')
