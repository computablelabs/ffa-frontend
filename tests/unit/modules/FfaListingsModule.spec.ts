...
describe('FfaListingsModule.ts', () => {
  ...
  it('correctly mutates listed via action', async () => {
    ...
    expect(module.listed.length).toBe(5)
    expect(module.listed[0].title).toEqual('title6')
    expect(module.listed[1].title).toEqual('title7')
    expect(module.listed[2].title).toEqual('title8')
    expect(module.listed[3].title).toEqual('title9')
    expect(module.listed[4].title).toEqual('title10')
  })
})
