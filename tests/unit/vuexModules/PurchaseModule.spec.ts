...
describe('PurchaseModule.ts', () => {
  ...
  it('correctly exposes getters', () => {
    ...
    expect(purchaseModule.erc20TokenMinedProcessId).toEqual('')
    expect(purchaseModule.approvalMinedProcessId).toEqual('')
    expect(purchaseModule.purchaseListingMinedProcessId).toEqual('')
  })
